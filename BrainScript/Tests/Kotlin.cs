...
{
    public partial class Kotlin : Form
    {
        int quection_count;
        int correct_answers;
        int wrong_answers;
        ...
        void start()
        {
            ...
            try
            {
                ...
                Read = new System.IO.StreamReader(System.IO.Directory.GetCurrentDirectory() + @"\kotlin.txt", Encoding);
        ...
        private void Kotlin_Load(object sender, EventArgs e)
        {
            button1.Text = "Следующий вопрос";
            button2.Text = "Выход";
